...
import 'package:baatcheet/GeoLocation/geolocation.dart';
import 'package:baatcheet/charts.dart';
import 'package:baatcheet/page_navigator.dart';
    ...
    return Scaffold(
            ...
            onPressed: () {
              showDialog(
                ...
                builder: (_) => AlertDialog(
                  ...
                  elevation: 24.0,
                  title: Text(
                    FlutterI18n.translate(context, 'app.newgroup'),
                  ...
                  actions: <Widget>[
                    FlatButton(
                      child: Text(FlutterI18n.translate(
                          context, 'app.creategroup')), // newgroup in i18n
                      onPressed: () {
      ...
      drawer: Drawer(
        child: Scaffold(
          appBar: AppBar(
            backgroundColor: Colors.green[400],
            title: Text(FlutterI18n.translate(context, 'app.extras'),
          ...
          body: ListView(
            ...
            children: <Widget>[
              ...
              ListTile(
                ...
                title: Text(FlutterI18n.translate(context, 'app.logout'),
                    style: TextStyle(color: Colors.black)),
                onTap: () async {
                  showSimpleFlushBar(
                      context,
                      FlutterI18n.translate(
                          context, 'app.successfullysignedout'));
                  await _auth.signOut();
                },
              ),
              ListTile(
                ...
                title: Text(FlutterI18n.translate(context, 'app.usersettings'),
                    style: TextStyle(color: Colors.black)),
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => InternationalizationPage()),
                  );
                },
              )
            ],
    ...
    return snapshot.data.documents.map<Widget>((document) {
      return ListTile(
          onTap: () {
            ...
            widget.pageNavigatorState.selectedGroupName =
          ...
          leading: CircleAvatar(
            ...
            backgroundImage: NetworkImage(document["picture"]) != null
                ? NetworkImage(document["picture"])
                : null,
          ),
          title: Row(
            children: <Widget>[
          ...
          subtitle: Row(
            children: <Widget>[
              Text((document['lastUser'] != null ? document['lastUser'] : " ") +
                  ": "),
              Text((document['lastMessage'] != null
